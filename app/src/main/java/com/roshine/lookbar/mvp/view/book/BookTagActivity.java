...
import com.roshine.lookbar.mvp.base.BaseToolBarActivity;
import com.roshine.lookbar.mvp.view.adapter.OtherAdapter;
...
import com.roshine.lookbar.wight.DragAdapter;
import com.roshine.lookbar.wight.DragGrid;
import com.roshine.lookbar.wight.OtherGridView;
 ...
 */
public class BookTagActivity extends BaseToolBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void initViewData(Bundle savedInstanceState) {
        ...
        tvTitleRight.setText(getResources().getString(R.string.save_tag_text));
        tvTitle.setText(getResources().getString(R.string.set_book_tag));
